 ...
 * adding the Cast button to the action bar.
 *
...
public class MediaRouterActionBarButtonActivity extends ActionBarActivity {
  ...
  private static final String TAG = MediaRouterActionBarButtonActivity.class.getSimpleName();
  ...
  private class MyMediaRouterCallback extends MediaRouter.Callback {
    ...
    public void onRouteSelected(MediaRouter router, RouteInfo info) {
      ...
      // app
      Toast.makeText(MediaRouterActionBarButtonActivity.this, getString(R.string.todo_connect), Toast.LENGTH_LONG)
          .show();
    }
