 ...
 */
public class MediaRouterCustomDialogActivity extends FragmentActivity {

  private static final String TAG = MediaRouterCustomDialogActivity.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mMediaRouteSelector = new MediaRouteSelector.Builder().addControlCategory(CastMediaControlIntent
        .categoryForCast(getResources().getString(R.string.app_id))).build();
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    if (item != null) {
      ...
      button.setDialogFactory(mCustomMediaRouteDialogFactory);
  ...
  private class MyMediaRouterCallback extends MediaRouter.Callback {
    ...
    public void onRouteSelected(MediaRouter router, RouteInfo info) {
      ...
      // app
      Toast.makeText(MediaRouterCustomDialogActivity.this, getString(R.string.todo_connect) + '\n' + getString(R.string.custom_dialog), Toast.LENGTH_LONG)
          .show();
    }
