...
public class MediaRouterButtonActivity extends FragmentActivity {
  ...
  private static final String TAG = MediaRouterButtonActivity.class.getSimpleName();
  ...
  private class MyMediaRouterCallback extends MediaRouter.Callback {
    ...
    public void onRouteSelected(MediaRouter router, RouteInfo info) {
      ...
      // app
      Toast.makeText(MediaRouterButtonActivity.this, getString(R.string.todo_connect), Toast.LENGTH_LONG)
          .show();
    }
