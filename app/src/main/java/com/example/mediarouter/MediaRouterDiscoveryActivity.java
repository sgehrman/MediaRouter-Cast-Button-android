...
public class MediaRouterDiscoveryActivity extends Activity {
  ...
  private static final String TAG = MediaRouterDiscoveryActivity.class.getSimpleName();
  ...
  private class MyMediaRouterCallback extends MediaRouter.Callback {
    ...
    public void onRouteSelected(MediaRouter router, RouteInfo info) {
      ...
      // app
      Toast.makeText(MediaRouterDiscoveryActivity.this, getString(R.string.todo_connect), Toast.LENGTH_LONG)
          .show();
    }
